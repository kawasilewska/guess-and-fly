...
/** 
 * Klasa generujaca ekran wyniku otrzymanego w poziomie pierwszym
 * @author Kamila Wasilewska
 */
public class ScoreState1 extends BasicGameState {
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		score = "Twój wynik: " + LoadingState.points1;
	...
	/** Przypisanie numeru identyfikacyjnego klasie ScoreState1 */
	@Override
	public int getID() {
		return 30;
	}

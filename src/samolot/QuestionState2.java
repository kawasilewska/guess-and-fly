...
/** 
 * Klasa generujaca pytania w poziomie trzecim
 * @author Kamila Wasilewska
 */
public class QuestionState2 extends BasicGameState {
	/** Obraz z pytaniem */
	private Image q1;
	/** Obraz z pytaniem */
	private Image q2;
	...
	public QuestionState2() {
		super();
	}

	/** Inicjowanie klasy QuestionState2 */
	@Override
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		q1 = new Image("images/3.1.png");
		q2 = new Image("images/3.2.png");
		q3 = new Image("images/3.3.png");
		q4 = new Image("images/3.4.png");
		q5 = new Image("images/3.5.png");
		q6 = new Image("images/3.6.png");
		q7 = new Image("images/3.7.png");
		q8 = new Image("images/3.8.png");
		q9 = new Image("images/3.9.png");
		q10 = new Image("images/3.10.png");
	}
	...
	/** Przypisanie numeru identyfikacyjnego klasie QuestionState2 */
	@Override
	public int getID() {
		return 22;
	}

...
/** 
 * Klasa generujaca pytania w poziomie drugim
 * @author Kamila Wasilewska
 */
public class QuestionState1 extends BasicGameState {
	/** Obraz z pytaniem */
	private Image q1;
	/** Obraz z pytaniem */
	private Image q2;
	...
	public QuestionState1() {
		super();
	}

	/** Inicjowanie klasy QuestionState1 */
	@Override
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		q1 = new Image("images/2.1.png");
		q2 = new Image("images/2.2.png");
		q3 = new Image("images/2.3.png");
		q4 = new Image("images/2.4.png");
		q5 = new Image("images/2.5.png");
		q6 = new Image("images/2.6.png");
		q7 = new Image("images/2.7.png");
		q8 = new Image("images/2.8.png");
		q9 = new Image("images/2.9.png");
		q10 = new Image("images/2.10.png");
	}
	...
	/** Przypisanie numeru identyfikacyjnego klasie QuestionState1 */
	@Override
	public int getID() {
		return 21;
	}
